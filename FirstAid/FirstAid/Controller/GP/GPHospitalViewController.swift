//
//  GPHospitalViewController.swift
//  FirstAid
//
...
class GPHospitalViewController: UIViewController, IndicatorInfoProvider {
    ...
    public func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "Assigned")
    }
...
extension GPHospitalViewController:UITableViewDelegate, UITableViewDataSource {
