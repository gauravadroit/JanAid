...
class GPPatientHistoryAutoComplete: UIViewController {
    ...
    func getSearchData(name:String) {
        ...
        request =  Alamofire.request(Webservice.getHistory, method: .post, parameters:parameter, encoding: URLEncoding.default, headers:Webservice.header).responseJSON { response in
