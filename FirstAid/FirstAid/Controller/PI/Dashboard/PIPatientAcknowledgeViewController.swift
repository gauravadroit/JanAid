//
//  PIPatientAcknowledgeViewController.swift
//  FirstAid
//
...
class PIPatientAcknowledgeViewController: UIViewController, IndicatorInfoProvider {
 ...
 var patientArr:[patient] = []
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "SCHEDULED")
    }
...
extension PIPatientAcknowledgeViewController:UITableViewDelegate, UITableViewDataSource {
