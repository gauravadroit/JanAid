//
//  PIPatientAllViewController.swift
//  FirstAid
//
...
class PIPatientAllViewController: UIViewController, IndicatorInfoProvider {
...
extension PIPatientAllViewController:UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.patientArr[indexPath.row].puStatus == "New" {
           ...
           // cell.statusLabel.text = self.patientArr[indexPath.row].status
        ...
        }else if self.patientArr[indexPath.row].puStatus == "Completed" {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "Scheduled", for: indexPath) as! PIPatientCell
            cell.countLabel.text = String(indexPath.row + 1)
            cell.doctorNameLabel.text = "Dr. " + self.patientArr[indexPath.row].doctorName
            cell.mobileLabel.text = self.patientArr[indexPath.row].mobileNumber
            cell.patientNameLabel.text = self.patientArr[indexPath.row].patientName
            ...
            cell.actionBtn.tag = indexPath.row
            cell.actionBtn.addTarget(self, action: #selector(self.actionBtn(Sender:)), for: .touchUpInside)
            cell.PIStatusLabel.textColor = UIColor.blue
            cell.selectionStyle = .none
            return cell
