//
//  PIDentalAllViewController.swift
//  JanAid
//
...
class PIDentalAllViewController: UIViewController, IndicatorInfoProvider {
...
extension PIDentalAllViewController:UITableViewDelegate, UITableViewDataSource {
