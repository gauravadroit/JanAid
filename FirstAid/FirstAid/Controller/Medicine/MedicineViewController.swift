...
class MedicineViewController: UIViewController {
    ...
    func getSearchData(name:String) {
        ...
        request =  Alamofire.request(Webservice.searchProduct + "\(replaced)&pageSize=15&city=\(location)&pageNumber=0&type=product", method: .get, encoding: JSONEncoding.default, headers:headers).responseJSON { response in
